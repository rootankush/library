...
submitBtn.addEventListener("click", (e) => {
  ...
  if (formAuthor.validity.valueMissing) {
    authorError.textContent = "Author needed";
    error = true;
  } else {
  ...
  if (formPages.validity.valueMissing) {
    pagesError.textContent = "Pages needed";
    error = true;
  } else if (formPages.validity.typeMismatch) {
    pagesError.textContent = "input should be number";
    error = true;
  } else {
